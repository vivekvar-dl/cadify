...
def execute_python_code(code: str, only_execute: bool = False) -> str:
    """
    Have an LLM agent modify the code to ensure it executes properly.
    Even if it's clear that no modifications are needed, have it execute the code to verify proper operation.
    If it cannot be executed properly even after modifications, return "I cannot fix it."
    """
